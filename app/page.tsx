...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <header className="bg-gradient-to-r from-[#6b2cbf] to-blue-500 sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-white">
                ...
                <p className="text-xs text-blue-100">Real Estate Solutions</p>
              </div>
            </div>
            ...
            <Button
              variant="secondary"
              className="hidden md:flex bg-white text-blue-600 hover:bg-blue-50 font-medium"
      ...
      <section
        id="home"
        className="relative bg-gradient-to-br from-[#6b2cbf] via-blue-500 to-blue-400 py-16 lg:py-24 overflow-hidden"
      >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="text-white space-y-6">
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                ...
                and Property Dealer
                <br />
                <span className="text-blue-100">in Karachi</span>
              </h1>
            ...
            <div className="w-full">
              <Card className="bg-blue-600/30 backdrop-blur-sm border-blue-400/30">
                <CardContent className="p-6 lg:p-8">
                  <div className="text-center mb-6">
                    <h2 className="text-2xl lg:text-3xl font-bold text-white mb-2">Get a Free Consultation</h2>
                    <p className="text-blue-100">Submit your details below to get a call from your Estate Agent</p>
                  </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive real estate solutions tailoblue to meet all your property needs in Karachi
            </p>
          </div>
      ...
      <section id="properties" className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Featublue Properties</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            {displayedProperties.map((property) => (
              <Card key={property.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xl font-bold text-blue-600">PKR {property.price}</span>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600">{testimonial.property}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 lg:py-24 bg-blue-600 relative overflow-hidden">
            ...
            <div className="text-white space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">03xxxxxxxxx</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">chtalhaimran220@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">North Nazimabad Karachi</p>
                </div>
              </div>
